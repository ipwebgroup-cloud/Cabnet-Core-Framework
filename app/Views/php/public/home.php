    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                ...
                <p class="text-secondary">Public starter controller, session layer, flash system, and Bootstrap layout are working.</p>
                <dl class="row mb-0">
...
$title = $appName;
include BASE_PATH . '/app/Views/php/layouts/public.php';
