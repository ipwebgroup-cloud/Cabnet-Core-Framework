...
<div class="d-lg-flex admin-shell">
    <aside class="admin-sidebar bg-dark text-white p-3">
        <div class="mb-4">
            ...
            <div class="small text-white-50">v2.2 auth hardening</div>
        </div>
    ...
    <main class="admin-main flex-grow-1">
        <div class="border-bottom bg-white px-4 py-3">
            <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap">
                <div>
                    ...
                    <div class="small text-secondary">Reusable admin shell foundation</div>
                </div>
                <?php if ($isAuthenticated): ?>
        ...
        <div class="p-4">
            <?php include BASE_PATH . '/app/Views/php/partials/flash.php'; ?>
            <?= $content ?? '' ?>
        </div>
    </main>
</div>
